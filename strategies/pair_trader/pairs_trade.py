...
sym_list = {'DD':'XLF'}#,'ALJ':'XLB','ATW':'XLB','CAM':'XLB','DRQ':'XLB','ETE':'XLB','ETP':'XLB',
...
trade_size = 10000
start = datetime(2012, 6, 28, 0, 0, 0, 0, pytz.utc)
end = datetime(2013, 6, 27, 0, 0, 0, 0, pytz.utc)
...
if __name__ == '__main__':
    ...
    for sym in sym_list:
        ...
        save_string = 'results/charts/'+str(sym)+'_'+etf+'.pdf'
